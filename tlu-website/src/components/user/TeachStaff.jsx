...
function TeachStaff() {
  return (
    <div className="w-full relative">
      ...
      <div className='mt-40 ml-76 flex flex-row space-x-5 text-[#AB9B9B]'>
        <a href='/' className='hover:text-[#E82323] transition-all duration-500 ease-out'>Trang chủ</a>
        <p>&gt;</p>
        <p>Giới thiệu</p>
        <p>&gt;</p>
        <p className='text-[#E82323]'>Đội ngũ nhân sự</p>
      </div>
