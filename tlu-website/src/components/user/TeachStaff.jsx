  ...
  return (
    <div className="w-full relative">
      ...
      <main>
        ...
        <div className="container my-10 flex flex-col md:flex-row gap-50">
          {/* Đội ngũ nhân sự */}
            ...
            {[...Array(5)].map((_, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="md:w-2/3">
                    <p className="font-normal text-[20px] text-[#E82323] mt-[32px]">
                      Trưởng khoa
                    </p>
                    <p className="font-bold text-[24px] text-black hover:text-[#35c56c] transition-colors mt-[15px]">
                      Name
                    </p>
          ...
          <div className="md:w-1/3">
            <div className="border-2 border-gray-300 rounded-lg p-[30px]">
              <h2 className="text-2xl font-bold mb-6 border-b-[5px] border-[#E82323]">
                Chuyên gia hàng đầu
              </h2>
              {[...Array(4)].map((_, index) => (
                <div
