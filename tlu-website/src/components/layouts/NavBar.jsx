  ...
  return (
    <div className="w-full h-[105px] flex items-center justify-between px-60 py-4 bg-white shadow-lg fixed top-0 z-10">
      ...
      <div className="hidden md:flex flex-col items-end">
        {/* Đăng nhập */}
        { !user ? (
            <div className="mb-3 flex items-center gap-2 hover:text-red-500 transition-all duration-300 ease-out py-2">
            ...
            <div className="relative mb-3 z-50 transition-all duration-300 ease-out">
              ...
              <div className={`absolute left-0 mt-2 w-60 px-5 bg-white border border-gray-200 rounded-lg shadow-lg transition-all duration-300 ease-out ${isAvatarOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
                <Link to="/tro-ly-khoa/bai-viet" onClick={() => setIsAvatarOpen(false)} className="flex flex-row items-center text-[#192E58] hover:text-[#1677FF] text-left transition-all duration-500 ease-out gap-x-2 font-bold text-xs py-4"> 
        ...
        <div className="flex space-x-2">
          <div className="relative group hover:text-red-700 transition-all duration-300 ease-out">
            ...
            <div className="text-[#192F59] absolute left-0 mt-1 w-48 bg-white shadow-md rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-500 ease-out">
